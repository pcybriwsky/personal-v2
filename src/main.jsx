...
const AboutSection = () => (
  <section id="about" className="py-16 px-4 sm:px-6 lg:px-8">
    <div className="max-w-3xl mx-auto">
      <h2 className="text-lg font-mono mb-6">overview</h2>
      <div className="text-sm font-mono leading-relaxed space-y-4 animate-fade-in">
        <p>
          hi, I'm pete. I'm an <span className="highlight-effect">award winning artist</span> making art with data.
        </p>
        <p>
        ...
        <p>
          ...
          <p>
            I write about it weekly on <a href="https://substack.com/@petecybriwsky" className="hover-bounce-link">Substack</a> (<span className="hover-bounce">{calculateWeekStreak('2024-06-10')}</span>-weeks in a row)
          </p>
        <p>
          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className={`px-3 py-1 text-xs font-mono border border-black transition-colors ${
                  isManualMode 
                    ? 'bg-black text-white' 
